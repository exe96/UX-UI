...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const picture= document.querySelector('.picture-fill');
    picture.style.backgroundImage = "url('https://exe96.github.io/UX-UI/origin/cook.jpg')";
    picture.style.backgroundSize = "cover";
    picture.style.backgroundPosition = "center";
    pdf.create('.about-button',"https://exe96.github.io/UX-UI/pdf/portfolio-2.pdf");
    ...
    const picture= document.querySelector('.picture-fill');
    picture.style.backgroundImage = "url('https://exe96.github.io/UX-UI/origin/read.jpg')";
    picture.style.backgroundSize = "cover";
    picture.style.backgroundPosition = "center";
    pdf.create('.about-button',"https://exe96.github.io/UX-UI/pdf/caso-practico-3.pdf");
    ...
    const picture= document.querySelector('.picture-fill');
    picture.style.backgroundImage = "url('https://exe96.github.io/UX-UI/origin/joven-charlando.jpg')";
    picture.style.backgroundSize = "cover";
    picture.style.backgroundPosition = "center";
    ...
    const picture= document.querySelector('.picture-fill');
    picture.style.backgroundImage = "url('https://exe96.github.io/UX-UI/origin/person.png')";
    picture.style.backgroundSize = "cover";
    picture.style.backgroundPosition = "center";
    pdf.create('.about-button',"https://exe96.github.io/UX-UI/pdf/Exequiel Acosta Currículum Vitae.pdf");
}else{
